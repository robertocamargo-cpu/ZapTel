...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1778185641);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1778185641);
user_pref("app.update.lastUpdateTime.region-update-timer", 1778185641);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1778185641);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1775742054);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1778185641);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{293ef0d3-c1b4-4142-a9aa-5a0ea9474536}");
...
user_pref("browser.startup.lastColdStartupCheck", 1778185611);
...
user_pref("captchadetection.lastSubmission", 1775741);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECIRlNHz4UgBLBAhT/eRBCu/jyQ==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"6291f042-33d8-48dc-986d-0c8b3d41a6ec\",\"pictureinpicture@mozilla.org\":\"ff414510-1e37-4671-92be-481c8395f650\",\"screenshots@mozilla.org\":\"04d632df-8db2-4b80-99f6-8cdecdda3597\",\"webcompat@mozilla.org\":\"5251cc13-b30b-4644-a16f-e654139b7706\",\"firefox-compact-dark@mozilla.org\":\"710dfb72-9395-4b19-af32-9e0bb5b918b2\",\"addons-search-detection@mozilla.com\":\"06535543-4209-44b8-8529-4a75f3adc04f\",\"uBlock0@raymondhill.net\":\"8871e3af-2bd2-4d5a-8cca-a13c6faf868d\"}");
...
user_pref("idle.lastDailyNotification", 1775742368);
...
user_pref("media.gmp-manager.lastCheck", 1778185631);
user_pref("media.gmp-manager.lastEmptyCheck", 1778185631);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("media.hardware-video-decoding.failed", false);
user_pref("pdfjs.enabledCache.state", true);
user_pref("pdfjs.migrationVersion", 2);
user_pref("places.database.lastMaintenance", 1775742368);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1775742368352");
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECGxY9j8u3Yz4BAjvtT9wq4csPA==");
user_pref("storage.vacuum.last.index", 0);
user_pref("storage.vacuum.last.places.sqlite", 1775742368);
user_pref("toolkit.startup.last_success", 1778185604);
